...
- Simulators Hub includes a teaching-only **Diffusion Forward Process** viz (not a real image generator). Module 2 lab pytest expects **19 passed** after optional GPU-track plan tests (NumPy mechanics remain the required path).
