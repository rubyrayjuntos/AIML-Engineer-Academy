"""
Module 2 – LLM Architecture Mechanics (REFERENCE SOLUTIONS)
-----------------------------------------------------------
Complete NumPy implementations used when ``ACADEMY_SOLUTION=1`` (CI / graders).

Learners implement the TODOs in ``app/mechanics.py``. Do not edit this file
unless you are intentionally updating the graded reference answers.
"""
